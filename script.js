...
window.addEventListener('scroll',()=>{
  ...
  // ─── Attendants data ─────────────────────────
  const attendants = [
    { name: 'David Thiago', role: 'Consultor de Crédito', whatsapp: '5531982972332' },
    { name: 'Carla', role: 'Consultora de Crédito', whatsapp: '5531982972332' },
    { name: 'Ronaldo', role: 'Consultor de Crédito', whatsapp: '5531982972332' },
    { name: 'Leonardo', role: 'Consultor de Crédito', whatsapp: '5531982972332' },
    { name: 'Ana', role: 'Consultora de Crédito', whatsapp: '5531982972332' },
    { name: 'Everton', role: 'Consultor de Crédito', whatsapp: '5531982972332' },
    { name: 'Luiz', role: 'Consultor de Crédito', whatsapp: '5531982972332' }
  ];
...
(function initLoader(){
  ...
  const botResponses = {
    start: {
      text: "Olá! Seja bem-vindo(a) à Mig Digital Empréstimos. Recebemos sua mensagem e em breve o Luis fará seu atendimento.",
      options: [
